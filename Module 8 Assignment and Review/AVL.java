...
public class AVL<T extends Comparable<? super T>> {
    ...
    public void add(T data) {
        ...
        // purple color is class field, instance variable
    ...
    private AVLNode<T> addHelper(T data, AVLNode<T> root) {
        ...
        T nodeVal = root.getData();
        int compareVal = nodeVal.compareTo(data);
        if (compareVal == 0) {
            return root;
        ...
        // re-balance while we on the way back up the tree
        root = balance(root);
        return root;
    }
    ...
    public void updateHeightAndBF(AVLNode<T> currentNode) {
        // WRITE YOUR CODE HERE (DO NOT MODIFY METHOD HEADER)!
        // Unless it is a null node, any other AVLNode should have height >= 0
